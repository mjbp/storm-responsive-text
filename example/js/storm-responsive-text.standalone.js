...
(function(root, factory) {
   ...
   if (typeof exports !== 'undefined'){
       ...
       factory(mod.exports);
       root.StormResponsiveText = mod.exports.default
   }
...
var wholeNumberFontSizeOnly = function wholeNumberFontSizeOnly() {
  if (!('getComputedStyle' in window)) return;

  var testDiv = function () {
  ...
  return function () {
    var isWhole = computedStyle && computedStyle.getPropertyValue('font-size') === '14px';
...
var calculateSizes = function calculateSizes(node, maxWidth, maxFontSizePx, minFontSizePx) {
  var fontSize = void 0,
      wordSpacing = 0;

  node.style.float = 'left';

  var intervals = wholeNumberFontSizeOnly ? [8, 4, 1] : [8, 4, 1, 0.1],
      lineMax = void 0,
      newFontSize = void 0,
...
var getInnerWidth = function getInnerWidth(node) {
  return node.offsetWidth - (+window.getComputedStyle(node, null)['paddingLeft'].split('px').join('') + +window.getComputedStyle(node, null)['paddingRight'].split('px').join(''));
};

var StormResponsiveText = {
  init: function init() {
    this.throttledResize = index(this.setSize, 16);
  ...
  setSize: function setSize() {
    var sizes = calculateSizes(this.node, getInnerWidth(this.node.parentNode), this.settings.maxFontSizePx, this.settings.minFontSizePx);
...
var stormResponsiveText = { init: init };

exports.default = stormResponsiveText;;
}));
